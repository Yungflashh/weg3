...
const Form = () => {
  return (
    <form className=' bg-white w-[95%] md:w-[55%] mx-auto p-10 grid gap-0.5 mt-20 mb-10 shadow-2xl shadow-purple-300 rounded-xl'>
      ...
      <p className=' text=[18px] font-[400] text-[#616161] mb-0.5'>Send us yours message</p>
        <input className=' border-1 h-12 text-[14px] font-bold flex items-center px-3 border-gray-300' type="text" placeholder='Your Full Name' required/>
        <input className=' border-1 h-12 text-[14px] font-bold flex items-center px-3 border-gray-300' type="mail" placeholder='Email Address' required/>
